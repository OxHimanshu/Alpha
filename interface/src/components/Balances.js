...
function Balances () {
    ...
    const getBalances = async () => {
        ...
        const alphaERC20Contract = new ethers.Contract(tokenContract[chain.id].ALPHA_TOKEN_CONTRACT, alphaERC20ABI, provider);
    ...
    return (
        <div className="text-white rounded-l-[10px] mt-2 w-96 bg-black h-[883px] overflow-y-scroll">
            { isConnected ?
